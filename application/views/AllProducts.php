				...
				<div class="col-md-6 right">
					<div class="row">
						<div class="col-md-12">
							...
							<a href="../../productdetails/AddProduct/"><button type="button" class="btn btn-default">
								Add Product
							</button></a>
						</div>
					</div>
...
//Function To Display Popup
        ...
        function reassignproduct()
            {
                document.getElementById('reassignproduct').style.display = "block";
                if(false)
                    {
                        return true;
                    }
        ...
        function div_hide_reassign()
            {
                document.getElementById('reassignproduct').style.display = "none";
            }
